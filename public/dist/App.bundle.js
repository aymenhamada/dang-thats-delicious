...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get("http://localhost:7777/api/search?q=" + this.value).then(function (response) {
            var data = response.data;

            if (data.length) {
                searchResults.innerHTML = _dompurify2.default.sanitize(resultHtml(data));
                return;
            }
    ...
    searchInput.on('keyup', function (e) {
        ...
        var href = searchResults.querySelectorAll('.search__result');
...
(0, _typeAhead2.default)((0, _bling.$)('.search')).add;
